...
\draw (0.5,5) -- (0.5,10) -- (6.5,10) -- (6.5,5) -- (0.5,5);
...
\draw[dashed] (7, 0) -- (7, 29);
\draw[dashed] (8, 0) -- (8, 29);
\draw[dashed] (9, 0) -- (9, 29);
...
\node [right] at (33, 6) {Design and Tech Initiative};
\draw[o->] (30, 6) -- (33, 6);

% Autonomous Bike: 2015
\node [right] at (33, 5) {Autonomous Bike};
\draw[o->] (30, 5) -- (33, 5);
